...
extern const uint8_t _binary_mockup_origin_bin_start[];
extern const uint8_t _binary_mockup_origin_bin_end[];

static lv_image_dsc_t img_dsc_origin = {
    .header = {
    ...
    .data = _binary_mockup_origin_bin_start,
};
